...
exports.load = (app) => {
    ...
    app.get('/api/v1/rooms', validate(roomValidation.getRooms()), roomController.getAll);
    ...
    app.put('/api/v1/rooms/:id', validate(roomValidation.update()), roomController.inviteMembersToGroup);
    app.get('/api/v1/rooms/:id', validate(roomValidation.getMessages()), roomController.getById);
};
